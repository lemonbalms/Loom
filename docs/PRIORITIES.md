...
| **P1** | **신뢰 게이트** | Owner 사인 또는 R14(최근 diff) | Owner 선택 / R14 시 필수 | 대기 |
...
| 옵션 | 내용 |
|------|------|
| A | Owner가 0.13.x author-close를 **인정**한다고 PLAN Approval에 한 줄 |
| B | **R14**: 0.11–0.13 누적 diff 보안·정합성 리뷰 (Fable 5) |

권장: 다음 MINOR 전에 **A 또는 B 하나**.  
...
② TEST_PLAN P0 수동 1회 기록 (UC-1 + UC-3)
③ P1 Owner 사인 또는 R14
