...
#### 0.27.0 — 2026-07-21 (`pending-revision` **R43d 잔여 3건 4차 반영 완료 · R43e 대기** — **result 발행 단일 소유권 + ACK 경계 — relay ACK 실측 선결 · strict ACK 판정 · issuer 중앙화 + seq 소유권 이전 · tower currency 게이트 · fire-and-forget 제거** (MINOR))
