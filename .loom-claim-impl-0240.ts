/**
 * IMPL-0240 card.done 결과를 타워 보드에 반영 (L-2 검증 포함) + 인박스 정리.
 * card.done handoff: ho_628759a05322da30 (from mac-node) — card task_1322b92473c225c1.
 * 실행: LOOM_PROFILE=claude-impl bun run .loom-claim-impl-0240.ts
...
const doneId = "ho_628759a05322da30"; // [DONE] card.done from mac-node (IMPL-0240)
