...
- [orchestration] 2026-07-21 (34) `subagent_type` 지정 ≠ 실제 레인 — 신원 고지 의무화, 폐기는 발견자≠수정자 유지 여부로.
...
- [verification] 2026-07-19 (11) 핸드오프 힌트 교차검증: 스코프 힌트 전제를 위임 전 claude-mem으로 1회 대조(스테일 실증 2회).
<details><summary>경위·좌표</summary>
...
- [verification] 2026-07-21 (33) 검증자 지적은 결함 **존재**의 증거일 뿐 **서술**의 증거가 아니다 — 전칭 부정은 코드 대조.

- [verification] 2026-07-21 (36) 위임 스폰 **전에** `git log`로 핸드오프 스코프 대조 — "착수 지점" 표기가 교차검증을 건너뛰게 만든다(11의 3회차 재범).

- [verification] 2026-07-21 (37) 자문에 택1을 물을 땐 **내 리스크 서술도 검증 대상**이라 명시 — 전제 2건이 실제로 틀렸다. 자문 용어는 락 대조 후 채택.
